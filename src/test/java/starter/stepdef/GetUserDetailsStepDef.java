...
public class GetUserDetailsStepDef {
    ...
    public void sendRequestGetUserDetailsWithInvalidUserId() {
        SerenityRest
                .when().get(GorestAPI.GET_USER_DETAILS_WITH_ID);
    }
    ...
    @Given("Get user details with valid {int}")
    public void getUserDetailsWithValidID(int id) {
        gorestAPI.getUserDetailsWithEmailParam(id);
    }
